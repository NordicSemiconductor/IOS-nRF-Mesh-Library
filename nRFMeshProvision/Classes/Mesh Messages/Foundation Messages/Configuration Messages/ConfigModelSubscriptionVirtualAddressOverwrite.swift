//
//  ConfigModelSubscriptionVirtualAddressOverwrite.swift
//  nRFMeshProvision
//
...
public struct ConfigModelSubscriptionVirtualAddressOverwrite: ConfigVirtualLabelMessage, ConfigAnyModelMessage {
