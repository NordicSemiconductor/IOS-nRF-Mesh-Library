//
//  GenericOnPowerUpSetUnacknowledged.swift
//  nRFMeshProvision
//
...
public struct GenericOnPowerUpSetUnacknowledged: StaticMeshMessage {
    ...
    /// Creates the Generic Default Transition Time Set Unacknowledged message.
    ///
